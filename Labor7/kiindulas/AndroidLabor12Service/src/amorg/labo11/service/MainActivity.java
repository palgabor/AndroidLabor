...
public class MainActivity extends Activity {
	...
	private void addQuakeToArray(Quake quake) {
		// TODO ha a foldrenges erossege a beallitasokban megadott ertek folott van 
	...
	private void loadQuakesFromProvider() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				// TODO ha az uj foldrenges erossege a beallitasoknak megfelelo, akkor hozzaadjuk a tombhoz
